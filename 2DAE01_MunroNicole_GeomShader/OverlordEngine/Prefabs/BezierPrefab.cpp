...
void BezierPrefab::Update(const GameContext& gameContext)
{
	...
	if (m_ActivePoint == 0)
	{
		m_pP0_Sphere->UpdateColour({ 1.0f,0.0f,0.0f,1.0f });
		m_pP1_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP2_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP3_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
	}
	else if (m_ActivePoint == 1)
	{
		m_pP1_Sphere->UpdateColour({ 1.0f,0.0f,0.0f,1.0f });
		m_pP0_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f }); 
		m_pP2_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP3_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
	}
	else if (m_ActivePoint == 2)
	{
		m_pP0_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP1_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP2_Sphere->UpdateColour({ 1.0f,0.0f,0.0f,1.0f });
		m_pP3_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
	}
	else if (m_ActivePoint == 3)
	{
		...
		m_pP1_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP2_Sphere->UpdateColour({ 0.0f,0.0f,1.0f,1.0f });
		m_pP3_Sphere->UpdateColour({ 1.0f,0.0f,0.0f,1.0f });
	}
